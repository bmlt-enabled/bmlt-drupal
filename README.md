...
----------
***Version 3.9.4* ** *- TBD*
- Migrated away from submodules and using composer instead.
...
- Fixed a minor bug in the [bmlt_simple](http://bmlt.app/satellites/simple/) and [bmlt_table](http://bmlt.magshare.net/satellites/the-fast-table-display/) shortcodes, where supplying just a settings ID would be ignored.
